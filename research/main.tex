...
\subsubsection{Versión 2 (OpenMP)} primer intento de paralelización en memoria compartida con \texttt{\#pragma omp parallel for collapse(3)}. Al compartir los vectores de vértices y triángulos, fue necesario un lock global por celda activa, cuya contención limitaba la escalabilidad. Esta versión evidenció que el problema real no era el cálculo sino la consolidación del resultado, lo que motivó el cambio de paradigma.
